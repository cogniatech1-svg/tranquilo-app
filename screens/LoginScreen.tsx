...
type Mode = 'login' | 'signup' | 'authenticated'
...
export function LoginScreen({
  ...
  const [mode, setMode] = useState<Mode>(authenticatedEmail ? 'authenticated' : 'login')
        ...
        {mode === 'authenticated' && (
          <>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ;(e.target as HTMLButtonElement).style.background = '#0a4a42'
              }}
              onMouseLeave={(e) => {
                ;(e.target as HTMLButtonElement).style.background = '#0d6259'
              }}
            >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!loading) (e.target as HTMLButtonElement).style.background = '#f9fafb'
              }}
              onMouseLeave={(e) => {
