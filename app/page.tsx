...
export default function Home() {
  ...
  // ── RESTAURACIÓN: Cargar datos de abril 2026 (SIN MODIFICACIONES) ──────────
  useEffect(() => {
    if (!hydrated) return
    // Solo restaurar si NO hay datos de 2026-04
    if (monthlyHistory['2026-04']) return

    // Datos EXACTOS del CSV - SIN modificaciones
    const restoredData = {
      "2026-04": {
        income: 8752707,
        savings: 0,
    ...
    // CARGAR EXACTAMENTE - SIN MODIFICACIONES
    ...
    const totalExpenses = 11463039
    const balance = totalIncome - totalExpenses

    console.log('✅ RESTAURACIÓN COMPLETADA - ABRIL 2026')
    console.log({
      totalIncome,
      totalExpenses,
      balance,
